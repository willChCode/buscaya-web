<template>
  <div class="min-h-screen bg-gray-50 pb-20">
    ...
    <div class="max-w-4xl mx-auto px-3 mt-6">
      <div
        v-if="loading && !post"
      ...
      <div v-else-if="post" class="space-y-6">
        ...
        <div class="flex items-center justify-between px-3">
          <h2 class="font-bold text-base md:text-lg text-gray-900">
        ...
        <div class="space-y-8 px-3 pb-10">
          ...
          >
            ...
            <p class="mt-4 text-gray-400 font-medium italic">
    ...
    <div
      class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 px-3 py-3 z-50"
    >
      <div class="max-w-4xl mx-auto">
        <!-- Replying to indicator -->
        <div
          v-if="replyingTo"
          class="flex items-center justify-between py-1.5 px-3 mb-2 bg-primary-50 rounded-xl animate-in fade-in slide-in-from-bottom-2"
        >
          <span
            class="text-xs text-primary-700 font-bold uppercase tracking-tight"
          >
        ...
        <div class="flex items-center gap-3">
          ...
          <div class="flex-shrink-0 hidden sm:block">
            <img
              ...
              class="w-11 h-11 rounded-2xl border border-gray-100"
            />
            <div
              v-else
              class="w-11 h-11 rounded-2xl bg-gray-50 flex items-center justify-center border border-gray-100"
            >
          ...
          >
            ...
            <svg
              v-else
              xmlns="http://www.w3.org/2000/svg"
              class="h-6 w-6 transform rotate-45 -translate-x-0.5 translate-y-0.5 mb-2 ml-2"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
