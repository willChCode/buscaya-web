...
<template>
  ...
  >
    <div class="relative overflow-hidden rounded-t-xl">
      ...
      <div
        class="absolute top-3 left-3 bg-[#FFD100] px-2.5 py-1 rounded-lg flex items-center gap-1 border border-white/20 shadow-sm"
      >
        <svg
        ...
        <span class="text-black text-[9px] font-bold uppercase tracking-wide"
          >Patrocinado</span
        >
      </div>
      ...
      <div
        class="absolute bottom-3 right-3 bg-black/60 px-2 py-[2.2px] rounded-lg backdrop-blur-md flex items-center gap-0.5"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="px-3 py-3">
      ...
      <div class="flex items-center justify-between mb-1.5">
        <span
          class="text-[11px] font-bold text-[#2d7a5d] uppercase tracking-wider truncate pr-2"
        >
      ...
      <!-- Title -->
      <h3
        class="font-bold md:font-semibold text-[#1a2639] leading-tight truncate mb-2.5"
      ...
      <div class="flex items-center justify-between mt-auto">
        ...
        <div class="flex items-center gap-1">
          ...
          <span class="text-[14px] font-bold text-[#1a2639]">{{
            Number(negocio.promedio || 0).toFixed(1)
          }}</span>
          <span class="text-[13px] font-medium text-gray-400 ml-0.5"
        ...
        <!-- Ver detalles -->
        <div
          class="flex items-center text-[13px] font-bold text-primary-900 hover:text-primary-800 transition-colors"
        >
