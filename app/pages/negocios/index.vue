<template>
  <div class="pt-5 px-4 md:px-6">
    ...
    <div class="mt-6 md:mt-4">
      ...
      >
        <template v-if="store.cargando && store.negociosHome.length === 0">
          <BusinessSkeleton v-for="n in 5" :key="n" class="w-[285px] flex-shrink-0" />
        </template>
        <div v-else-if="store.negociosHome.length === 0" class="w-full text-center py-8">
            ...
            <p class="text-gray-500 font-medium text-sm">No hay negocios en esta zona.</p>
            <p class="text-xs text-gray-400 mt-1">Intenta cambiar tu ubicación.</p>
        </div>
        <template v-else>
          <component
    ...
    <div class="mt-6 mb-12">
      <CarouselSection title="Nuestras promociones" linkTo="/revista" linkText="Ver revista">
  ...
  <div class="w-full bg-gray-900 text-gray-300 py-12 border-t border-gray-800">
      <div class="container mx-auto px-4 md:px-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8 items-center">
              ...
              <div class="col-span-1 flex flex-col items-center md:items-start text-center md:text-left">
                  <div class="flex items-center justify-center md:justify-start gap-3 mb-5">
                       <img src="~/assets/images/logo/buscaya-logo-blanco.png" alt="Buscaya" class="h-8 w-auto opacity-100" />
                       <!-- <span class="text-2xl font-bold text-white tracking-tight">Buscaya Negocios</span> -->
                  </div>
                  <p class="text-gray-400 text-sm leading-relaxed mb-6 max-w-sm font-light mx-auto md:mx-0">
                      La plataforma líder para conectar negocios locales con clientes en tiempo real. Descubre, conecta y crece con nosotros.
                  </p>
                  <div class="flex space-x-4 justify-center md:justify-start">
                      <!-- Facebook -->
                      <a href="https://www.facebook.com/buscaya.nl/" target="_blank" class="text-gray-400 hover:text-white transition-colors">
                          <svg class="h-6 w-6 -mt-[2px]" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/></svg>
                      </a>
                      <!-- Instagram -->
                      <a href="https://www.instagram.com/buscaya.mx" target="_blank" class="text-gray-400 hover:text-white transition-colors">
                      ...
                      <!-- WhatsApp -->
                      <a href="https://wa.me/528110720923" target="_blank" class="text-gray-400 hover:text-white transition-colors">
              ...
              <div class="col-span-1 flex flex-col items-center md:items-end text-center md:text-right">
                  <h4 class="text-xl md:text-[25px] font-extrabold leading-tight text-white mb-4">
                      Lleva tu negocio al 
                      <span class="text-[#FFD100]">siguiente nivel</span>
                  </h4>
                  <p class="text-gray-400 text-sm mb-8 max-w-lg leading-relaxed font-light mx-auto md:mr-0">
                      Únete a la plataforma de mayor crecimiento. Destaca con un perfil profesional y llega directo a los clientes que buscan lo que ofreces.
                  </p>
                  <a href="https://wa.me/528110720923?text=hola%2C%20vengo%20de%20su%20pagina%20web%20me%20gustaria%20registrar%20mi%20engocio%20en%20buscaYa" target="_blank" class="bg-[#FFD100] hover:bg-[#ffdb4d] text-gray-900 font-bold py-3 px-10 rounded-2xl transition-all duration-300 shadow-[0_10px_20px_-5px_rgba(255,209,0,0.3)] hover:shadow-[0_15px_30px_-5px_rgba(255,209,0,0.4)] hover:-translate-y-1 active:scale-95 flex items-center gap-3 group">
          ...
          <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500">
              <p>&copy; {{ new Date().getFullYear() }} Buscaya Inc. Todos los derechos reservados.</p>
