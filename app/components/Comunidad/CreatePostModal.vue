<template>
  <Dialog v-model="isOpen" class="z-50" widthClass="w-full max-w-lg mx-auto">
    <div class="bg-white rounded-xl overflow-hidden">
      ...
      <div class="p-5 flex-1 overflow-y-auto">
        ...
        <div class="mb-5">
          <label
            class="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-3 block"
            >Selecciona un tema</label
          >
          <div class="flex gap-2">
            ...
            >
              ...
              <span
                class="text-[10px] font-extrabold uppercase tracking-tight"
                >{{ cat.label }}</span
              >
            </button>
          </div>
        ...
        <div
          v-if="imagePreview"
          class="mb-5 relative group rounded-xl overflow-hidden border border-gray-100 shadow-sm"
        >
