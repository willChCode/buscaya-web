...
<template>
  <div class="w-full px-3 pb-20 pt-6 md:px-4">
    <!-- Title / Header -->
    ...
    <!-- Loading State -->
    <div
      v-if="revistaStore.loading && revistaStore.revistas.length === 0"
      class="w-full max-w-[1700px] mx-auto min-h-[500px] flex items-center justify-center"
    >
      <div
    ...
    <!-- Empty State -->
    <div
      v-else-if="!revistaStore.loading && revistaStore.revistas.length === 0"
      class="flex flex-col items-center justify-center py-20 text-center"
    >
      <div
        class="inline-flex items-center justify-center w-24 h-24 rounded-full bg-gray-50 mb-6"
      >
        <svg
      ...
      <p class="text-gray-500 max-w-sm mx-auto">
        No hay revistas disponibles en esta ubicación. Intenta cambiar el radio
        de búsqueda.
      </p>
    </div>
    ...
    <div v-else class="w-full max-w-[1700px] mx-auto">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-[6px] md:gap-3">
        ...
        >
          ...
          <div
            class="absolute bottom-6 left-6 right-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          >
            <div class="flex justify-end">
              <div
                class="w-10 h-10 rounded-full bg-white/20 backdrop-blur-md flex items-center justify-center"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
