<template>
  <div class="bg-white rounded-2xl shadow-sm p-4 sm:p-8 min-h-[400px]">
    <div class="flex items-center gap-4 mb-8">
      ...
      <div>
        <h1 class="text-[22px] sm:text-2xl font-bold text-gray-900">
          Configuración
        </h1>
        <p class="text-gray-500 text-sm">
          Ajusta tus preferencias de búsqueda y aplicación.
        </p>
      </div>
    </div>
    ...
    <div class="space-y-8 max-w-3xl">
          ...
          >
            <div class="flex items-center gap-4">
              ...
              <span
                class="font-medium"
                :class="
                  localRadius === dist ? 'text-primary-600' : 'text-gray-900'
                "
              >
                {{
                  dist === 20000
      ...
      <section>
        ...
        >
          <button
            ...
            class="w-full flex items-center justify-between p-4 bg-white border-b border-gray-100 hover:bg-gray-50 transition-colors text-left"
          >
            <div class="flex items-center gap-4">
              <div
                class="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center"
              ...
              <div>
                <span
                  ...
                  :class="
                    localUnit === 'km' ? 'text-primary-600' : 'text-gray-900'
                  "
                  >Kilómetros (km/m)</span
                >
            ...
            <div class="flex items-center gap-4">
              ...
              <div>
                <span
                  class="block font-medium"
                  :class="
                    localUnit === 'mi' ? 'text-primary-600' : 'text-gray-900'
                  "
                  >Millas (millas/pies)</span
                >
        ...
        >
          <div class="flex items-center justify-between p-4 bg-white">
            <div class="flex items-center gap-4 flex-1">
              ...
              <div>
                <span class="block font-medium text-gray-900"
                  >Caché de Imágenes</span
                >
                <span class="text-xs text-gray-500 block"
                  >Guardar imágenes para cargar más rápido (Simulado en
                  Web)</span
                >
              </div>
            </div>
            <button
              ...
              :class="
                settingsStore.imageCacheEnabled
                  ? 'bg-primary-500'
                  : 'bg-gray-200'
              "
            >
      ...
      <section>
        ...
        <div
          class="bg-gray-50 rounded-2xl overflow-hidden border border-gray-100 divide-y divide-gray-100"
        >
          <NuxtLink
            to="/soporte"
            class="w-full flex items-center justify-between p-4 bg-white hover:bg-gray-50 transition-colors text-left"
      ...
      <section>
        <h3
          class="text-xs font-bold text-red-400 uppercase tracking-wider mb-3 ml-1"
        >
          Zona de Peligro
        </h3>
        <div
          class="bg-red-50 rounded-2xl overflow-hidden border border-red-100"
        >
          <button
            @click="handleDeleteAccount"
            class="w-full flex items-center justify-between p-4 bg-white hover:bg-red-50 transition-colors text-left group"
          >
            <div class="flex items-center gap-4">
              <div
                class="w-8 h-8 rounded-full bg-red-100 flex items-center justify-center group-hover:bg-red-200 transition-colors"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5 text-red-300 group-hover:text-red-500"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
    ...
    <!-- Save Actions -->
    <div
      class="sticky bottom-0 mt-8 -mb-4 -mx-4 sm:-mb-8 sm:-mx-8 p-4 bg-white border-t border-gray-100 flex justify-end"
    >
      <button
        @click="saveChanges"
        :disabled="isSaving"
