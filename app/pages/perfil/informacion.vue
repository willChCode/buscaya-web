<template>
  <div class="bg-white rounded-2xl shadow-sm p-5 sm:p-10 h-full relative">
    <!-- Loading Overlay -->
    <div
      v-if="loading"
    ...
    <div
      class="border-b border-gray-200 pb-6 mb-6 flex justify-between items-center"
    >
      <div>
        <h2 class="text-[22px] sm:text-2xl font-bold text-gray-900">
          Información Personal
        </h2>
        <p class="text-gray-500 text-sm mt-1">
          Administra tu información básica y preferencias.
        </p>
      </div>
      <button
        v-if="!isEditing"
    ...
    <form @submit.prevent="handleSave" class="space-y-6 max-w-2xl">
      ...
      <div class="flex items-center gap-6">
        <div class="relative group">
          <div
            class="w-24 h-24 bg-gray-100 rounded-full overflow-hidden border-2 border-gray-100 shadow-sm"
          >
            <img
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <input
            ...
            :readonly="!isEditing"
            :class="{
              'bg-white ring-1 ring-primary-500 border-primary-500': isEditing,
              'bg-gray-50 border-gray-200 cursor-not-allowed': !isEditing,
            }"
      ...
      <div>
        ...
        >
        <div
          class="flex items-center bg-gray-50 border border-gray-200 rounded-xl px-4 py-3"
        >
          <code class="text-sm text-gray-500 font-mono flex-1">{{
            user?.uid
          }}</code>
        </div>
      </div>
